...
export class BiswapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class BiswapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class BiswapPair extends ethereum.SmartContract {
  static bind(address: Address): BiswapPair {
    return new BiswapPair("BiswapPair", address);
  }
  ...
  burn(to: Address): BiswapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new BiswapPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<BiswapPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BiswapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): BiswapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new BiswapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<BiswapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BiswapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
